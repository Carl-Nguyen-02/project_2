...
public class CashierOrderController implements ActionListener{
    ...
    public CashierOrderController(User cashier, SQLite sqlite, MongoDB mongoDB) {
        ...
        this.view.getCusBtn().addActionListener(this);
    ...
    private String generateOrderIDForCus() {
        return "CAS-" + System.currentTimeMillis();
    }
    ...
    private void finishTransaction(){
        ...
        order.setSourceType("Transaction"); //Transaction for Cashiers, Order for Customers
        order.setOrderID(generateOrderIDForCus()); // Generate a unique order ID
        order.setSourceID(String.valueOf(cashier.getUserID()));
